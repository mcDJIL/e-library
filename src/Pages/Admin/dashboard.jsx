              ...
              <div className="col-md-12 grid-margin">
                <div className="row">
                  <div className="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 className="font-weight-bold">Selamat Datang {name}</h3>
                          ...
                          <div className="row">
                            ...
                            >
                              <div className="ml-xl-4 mt-3">
                                ...
                                <h3
                                  className="font-weight-500 mb-xl-4 text-primary"
                                >
                                  North America
                                </h3>
                    ...
                    <div className="list-wrapper pt-2">
                      ...
                      >
                        ...
                        <li>
                          <div className="form-check form-check-flat">
                            <label className="form-check-label">
                              <input className="checkbox" type="checkbox" /> Level
                              up for Antony
                            </label>
                          </div>
                          <i className="remove ti-close"></i>
            ...
            <div className="row">
                      ...
                      <table className="table table-borderless">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <p className="mb-0">
                                <span className="font-weight-bold me-2">65</span
                                >(2.15%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p className="mb-0">
                                <span className="font-weight-bold me-2">54</span
                                >(3.25%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p className="mb-0">
                                <span className="font-weight-bold me-2">22</span
                                >(2.22%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p className="mb-0">
                                <span className="font-weight-bold me-2">46</span
                                >(3.27%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p className="mb-0">
                                <span className="font-weight-bold me-2">17</span
                                >(1.25%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p className="mb-0">
                                <span className="font-weight-bold me-2">52</span
                                >(3.11%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td className="pb-0">
                              <p className="mb-0">
                                <span className="font-weight-bold me-2">25</span
                                >(1.32%)
                              </p>
                            </td>
              ...
              <div className="col-md-4 stretch-card grid-margin">
                <div className="row">
                      ...
                      <div className="card-body">
                        ...
                        <div className="charts-data">
                          <div className="mt-3">
                            ...
                            >
                              <div
                                className="progress progress-md flex-grow-1 me-4"
                              >
                                <div
                  ...
                  <div
                    className="col-md-12 stretch-card grid-margin grid-margin-md-0"
                  >
